...
void flowsim2(int neventsmax=100,  int nharmonic=2) {
  /*
...
4 particle correlation should be -vn^4  
  ...
  //  std::ifstream infile("ampt_200.dat");
  //   ymaxcut=4.;
  std::ifstream infile("ampt_7p2.dat");
  ymaxcut=1.8;// 4 for 200 GeV, 1.8 for 7.2 GeV
  bool doloop = false;
  ...
  // Open a ROOT file and save the formula, function and histogram
   //
   TFile *myfile = new TFile("flowsim2.root","RECREATE");
