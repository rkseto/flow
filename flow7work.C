...
4 particle correlation should be -vn^4  
  ...
  TH1D *reseventplaneh = new TH1D("reseventplaneh","event plane reslution event",2000,0.0,1.00);
   ...
   cout<<endl;
   cout<<" nevents="<<nevents<<"  nparticlesav="<<nparticlesav<<" nharmonic="<<nharmonic<<" doloop3="<<doloop3<<" doloop4="<<doloop4<<endl;
   cout<<endl;
   cout<<"Initial values: v1="<<v1
       ...
       <<"  v4="<<v4
       <<endl;
   cout<<"give initial v values pt dependence: "<<ptdepv<<endl<<endl;
   ...
   //
   TFile *myfile = new TFile("flow7.root","RECREATE");
