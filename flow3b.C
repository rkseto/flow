...
4 particle correlation should be -vn^4  
  ...
  // we will define our histograms here
   ...
   pad1->cd();   
                  ...
                  //FXT3GeV//200GeV //test
   double v1=0.0; //0.02   // 0.05; // 0.1 // 0
   double v2=0.05; //0.05   //0.15;  // 0.2 // 0.05
   double v3=0.00; //0.01  //0.07;  //0.15  //0.
   double v4=0.00; //0.02  //0.03;  //0.05  //0.
   ...
   //
   TFile *myfile = new TFile("flow3b.root","RECREATE");
